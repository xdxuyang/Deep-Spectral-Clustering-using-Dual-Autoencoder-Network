...
class SpectralNet:
    def __init__(self, inputs, arch, spec_reg, y_true, y_train_labeled_onehot,
            n_clusters, affinity, scale_nbr, n_nbrs, batch_sizes,P,
        ...
        # define loss
        # np.save('W.npy', W)
        # P = tf.convert_to_tensor(P, np.float32)
        # celoss = losses.kullback_leibler_divergence(P,self.outputs['Unlabeled'])
    ...
    def train(self, x_train_unlabeled, x_train_labeled, x_val_unlabeled,P,
